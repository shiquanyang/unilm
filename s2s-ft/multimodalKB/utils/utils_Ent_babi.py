...
def generate_memory(sent, speaker, time, image_feas):
    ...
    if speaker=="$u" or speaker=="$s":
        ...
        try:
            ...
            elif sent_token[1].startswith("R_image"):
...
def prepare_data_seq(task, batch_size=100):
    ...
    # data_path = '/home/yimeng/shiquan/Multimodal-Knowledge-Base/data/0_synthetic/dialog-babi'
    # img_path = '/home/yimeng/shiquan/Multimodal-Knowledge-Base/images/restaurant'
    file_train = '{}-trn-multimodal-extended-kb-gold.txt'.format(data_path)
    # file_train = '{}-task{}trn.txt'.format(data_path, task)
    file_dev = '{}-dev-multimodal-extended-kb-gold.txt'.format(data_path)
    # file_dev = '{}-task{}dev.txt'.format(data_path, task)
    file_test = '{}-tst-multimodal-extended-kb-gold.txt'.format(data_path)
