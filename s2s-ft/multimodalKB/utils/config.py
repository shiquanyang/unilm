...
# parser.add_argument('-convkernelsize','--convkernelsize', help='convolutional kernel size', type=int, required=False, default=3)
# parser.add_argument('-poolkernelsize','--poolkernelsize', help='pool kernel size', type=int, required=False, default=3)
